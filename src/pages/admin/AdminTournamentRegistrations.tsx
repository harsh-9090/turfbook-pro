          ...
          <table className="w-full text-sm text-left">
            <thead className="text-xs uppercase bg-muted/50 text-muted-foreground font-bold">
              <tr>
                ...
                <th className="px-6 py-4 text-right">Order Ref</th>
              </tr>
            </thead>
            <tbody>
              {loading ? (
                <tr><td colSpan={6} className="text-center py-8 text-muted-foreground">Loading specific registrations...</td></tr>
                ...
                registrations.map((r) => (
                  <tr key={r.id} className="border-b border-border/50 hover:bg-muted/20 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="text-[10px] font-mono text-muted-foreground truncate w-32 ml-auto" title={r.razorpay_payment_id || r.razorpay_order_id || "-"}>
