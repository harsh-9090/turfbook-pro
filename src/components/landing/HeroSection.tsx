  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img src={heroImage} alt="Premium sports turf field" className="w-full h-full object-cover" width={1920} height={1080} />
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10 pt-20">
        <div className="max-w-3xl">
          ...
          >
            ...
            <span className="text-sm font-medium text-primary">#1 Rated Turf in the City</span>
          </motion.div>
          ...
          >
            Book Your
            <br />
            <span className="text-gradient-turf">Perfect Game</span>
            <br />
            Anytime
          </motion.h1>
          ...
          >
            Premium artificial turf with world-class facilities. Book your slot in seconds, pay online, and just show up to play.
          </motion.p>
          ...
          >
            {[
              { icon: Users, label: "5000+", sub: "Games Played" },
              { icon: Star, label: "4.9", sub: "Rating" },
              { icon: Clock, label: "6AM-11PM", sub: "Available" },
            ].map((stat) => (
